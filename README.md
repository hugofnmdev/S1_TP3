TP3 - List: Toolbox
Date
Practice start	monday october 18th 9h
Final due	tuesday october 26th 23h42
LOGIN@git.cri.epita.fr:p/2026-s1-caml/tp3-LOGIN
...
📝Subject
You will find the last version of the subject here: Sujet_V1.1

To start, clone your repository:

git clone LOGIN@git.cri.epita.fr:p/2026-s1-caml/tp3-LOGIN
ℹ️ Don't forget to replace LOGIN with your login, e.g. john.smith.
...
└─📁tp3-LOGIN/
  ...
  ├─🐫histo.ml
  └─🐫matrix_patterns.ml
Exercises from the "Toolbos" section must be in list_tools.ml. Exercises 1 and 2 from the "Midterms" section must be respectively in histo.ml and matrix_patterns.ml.
